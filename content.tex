...
\begin{verbatim}
+-------------------------------------------------------------------------------+
|                        CASCADED SPEECH-TO-TEXT NORMALIZATION                  |
+-------------------------------------------------------------------------------+
| [Dialectal Audio Input] (Malvani D1 / Ahirani D2 / Varhadi D4)               |
|                           |                                                   |
|                           v                                                   |
| [Stage 1: ASR System] ---> ai4bharat/indic-conformer-600m-multilingual (RNN-T)|
|                           | (Baseline ASR Output WER: 23.71%)                 |
|                           v                                                   |
| [Stage 2: Raw Transcript] (Phonetic dialectal text with non-standard suffixes) |
|                           |                                                   |
|                           v                                                   |
| [Stage 3: Normalizer] ---> google/mT5-small (300M, 250k Vocab, Fine-Tuned)     |
|                           | (Post-Normalization Output WER: 16.58%)           |
|                           v                                                   |
| [Standard Output] -------> Normative Standard Written Marathi (मानक मराठी)       |
|                            (Overall Rel. WER Reduction: -30.07% vs ASR)       |
+-------------------------------------------------------------------------------+
\end{verbatim}
\end{small}
