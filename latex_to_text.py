...
def chunk_text(text: str, max_words: int = 100) -> str:
...
def main():
    ...
    parser.add_argument("-w", "--words", type=int, default=100, help="Maximum number of words per paragraph chunk (default: 100)")
