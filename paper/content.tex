...
\caption{Single-dialect 5-fold cross-validation performance shift (Dumbbell Plot) comparing Original and Synthetically Expanded models for IndicBART (244M) and mT5-small (300M).}
\label{fig:single_dialect_dumbbell}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=0.92\textwidth]{figures/fig4_slope.pdf}
\caption{Single-dialect 5-fold cross-validation slope chart tracking BLEU score trajectories from Original to Synthetically Expanded corpora.}
\label{fig:single_dialect_slope}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=0.92\textwidth]{figures/fig4_radar.pdf}
\caption{Single-dialect polar radar profile comparison illustrating benchmark metric coverage across sub-dialects for IndicBART (244M) and mT5-small (300M).}
\label{fig:single_dialect_radar}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/fig5_multidialect_heatmap.pdf}
\caption{Multi-dialect 5-fold cross-validation performance matrix: (A) Absolute BLEU score heatmap across model architectures and corpora partitions, and (B) Net synthetic expansion impact ($\Delta$ BLEU).}
